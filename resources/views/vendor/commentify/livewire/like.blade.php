<span class="inline-flex items-center text-sm">
  <button wire:click="like" class="inline-flex space-x-2 {{ $comment->isLiked() ? 'text-green-400 hover:text-green-500' : 'text-slate-400 hover:text-slate-500' }} focus:outline-none focus:ring-0">
