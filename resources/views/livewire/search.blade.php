<div x-data="{ isOpen: false }" @keydown.escape.window="isOpen = false">
    <button x-on:click="isOpen = true" class="flex items-center justify-center p-2 rounded-md hover:bg-gray-100">
    ...
    >
        ...
        <div class="relative flex items-start justify-center min-h-screen p-4 text-center">
            ...
            >
                ...
                <button 
                    @click="isOpen = false"
                    class="absolute p-1 text-gray-400 transition-colors duration-200 rounded-full top-4 right-4 hover:bg-gray-100 hover:text-gray-600"
                >
